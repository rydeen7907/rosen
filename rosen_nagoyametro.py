...
#例：名古屋市交通局の接続辺を抽出する 路線...line_cd == 99513---99518
metro_join = join[(join["line_cd"]==99513)|(join["line_cd"]==99514)|(join["line_cd"]==99515)|(join["line_cd"]==99516)|(join["line_cd"]==99517)|(join["line_cd"]==99518)]
...
# 駅名をテキストファイルに書き込み
with open('route_nagoyametro.txt', 'w', encoding='utf-8') as f:
